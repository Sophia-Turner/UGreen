...
Step 4: Create a bootable SD card with partition 2 as a regular Debian Bookworm install leaving partition 7 the UGreen flat filesystem boot. Worked... for 2 minutes; then the watchdog timer kicked in and rebooted the system. Debian does not have the custom UGreen kernel drivers to create the watdog timer major and minor numbers, therefore communication is not possible.
